...
- **Humans (a new co-president / board member) start with `HANDBOOK.md`** — the plain-English guide to what this is, the tools, how to change it, and how to hand it off.
